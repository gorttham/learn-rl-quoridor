...
class Agent:
    ...
    def q_learn(self):
        ...
        # print("states:", states) #list of states
        ...
        for i, b in enumerate(batch): 
            ...
            if next_state is None:
                ...
                # print("current_q[action]:", current_q[action])
...
class TopAgent(Agent):
    ...
    def __init__(self, static_actions, model):
        Agent.__init__(self, static_actions, model, BoardElement.AGENT_TOP)
...
class BottomAgent(Agent):
    ...
    def __init__(self, static_actions, model):
        Agent.__init__(self, static_actions, model, BoardElement.AGENT_BOT)
